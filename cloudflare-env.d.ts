/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 30eaaf543723efd0aaaf821c1e698ec1)
...
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	APP_URL: "https://ambrium.io";
	MOTHERDUCK_PROVIDER_PLAN: "free";
	...
	AWS_SAAS_ACCESS_KEY_ID: string;
	AWS_SAAS_SECRET_ACCESS_KEY: string;
	AWS_SAAS_REGION: string;
	AWS_SAAS_ACCOUNT_ID: string;
	CLOUDFLARE_PROVIDER_API_TOKEN: string;
	MOTHERDUCK_DATABASE_URL: string;
	CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_ANALYTICS_DB: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "MOTHERDUCK_PROVIDER_PLAN" | "NEXT_PUBLIC_CLERK_SIGN_IN_URL" | "NEXT_PUBLIC_CLERK_SIGN_UP_URL" | "NEXT_PUBLIC_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL" | "NEXT_PUBLIC_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_SLUG" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_PRIVATE_KEY" | "AWS_SAAS_ACCESS_KEY_ID" | "AWS_SAAS_SECRET_ACCESS_KEY" | "AWS_SAAS_REGION" | "AWS_SAAS_ACCOUNT_ID" | "CLOUDFLARE_PROVIDER_API_TOKEN" | "MOTHERDUCK_DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_ANALYTICS_DB" | "ANALYTICS_ENABLED" | "ANALYTICS_READS_ENABLED">> {}
}
